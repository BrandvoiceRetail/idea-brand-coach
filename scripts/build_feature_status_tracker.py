...
FEATURES: list[tuple] = [
    ...
    (
        ...
        24,
        0,
        "generate-brand-strategy-document edge function ships a unified strategy doc today. The Gen 3 Draft-vs-Forensic *tier* split (lighter doc after Layer 1, heavier after Avatar Builder) is the gap — current code doesn't distinguish them yet. DRAFT badge + Forensic upgrade CTA still needs design.",
    ),
    (
        "F-004",
