...
FEATURES: list[tuple] = [
    ...
    (
        ...
        32,
        0,
        'AUDIT 2026-05-16: V2 chapter UI delivers progressive disclosure + persistence well, but field schema flattens Gen 3 psychographic dimensions into coarse textareas (F-004.1 60%). 3 of 4 AI modes present; FieldChatButton missing from V2 (F-004.3 35%). Completion gate logic exists but button not mounted in render tree (F-004.5 55%).',
    ),
    (
        'F-005',
        ...
        32,
        0,
        "AUDIT 2026-05-16: V2 chapter map has no dedicated 'Buying Behaviour' chapter — closest is BUYER_INTENT which is conceptually different. V1 AvatarBuilder has the right tab. Data shape exists; UI split V1↔V2.",
    ),
    (
        'F-006',
        ...
        36,
        0,
        'AUDIT 2026-05-16: Emotional fields exist (EMOTIONAL_CONNECTION + CUSTOMER_EXPERIENCE chapters) but Gen 3 Emotional Journey framing absent; Trigger Moment field with elevated visual treatment (F-006.2) is the most prominent miss — zero hits in codebase.',
    ),
    (
        'F-007',
        ...
        40,
        0,
        'AUDIT 2026-05-16: Review intake is URL/ASIN-driven via ReviewAnalyzerModal (scrape model), not Gen 3 paste-raw-reviews model. voice-of-customer-analysis edge function DOES NOT EXIST. V1 analysis is fully mocked. Use/discard phrase cards (F-007.3) ~10%.',
    ),
    (
        'F-008',
    ...
    (
        ...
        48,
        0,
        "AUDIT 2026-05-16: Only ONE AI mode is independently invocable — a single 'Generate with AI' button per field (AIButton.tsx). 'Think About This' and 'Real-World Examples' modes don't exist; 'Auto-Populate' is delivered implicitly via chat extraction + ghost text. No 4-mode selector UI. Rollup dropped from 30→19%.",
    ),
    (
        'F-010',
