...
export function V4TopBar(): JSX.Element {
  return (
    <header className="v4-chrome sticky top-0 z-30 flex h-12 items-center justify-between border-b border-background/10 bg-foreground px-4 text-background md:hidden">
