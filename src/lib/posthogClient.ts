...
export type AlphaEventName =
  ...
  | 'positioning_statement_reveal_cta_shown'
  | 'positioning_statement_reveal_requested'
  | 'positioning_statement_options_shown'
  | 'positioning_statement_picked'
  ...
  | 'positioning_statement_reconsidered'
  | 'positioning_statement_rerolled'
