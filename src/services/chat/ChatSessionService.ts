...
export class ChatSessionService {
  ...
  async createSession(
    ...
    // context_avatar_ids is the per-thread retrieval anchor (set model), stamped when given.
    // Row built loosely (sidesteps jsonb/Json friction on chapter_metadata) then asserted
    // to the generated insert type at the call site.
