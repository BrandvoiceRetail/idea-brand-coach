...
function mRow(over: Partial<CampaignMetricRow>): CampaignMetricRow {
  return {
    id: 'm', user_id: 'user-1', campaign_id: 'c1', brand_asset_id: null, channel: 'amazon',
    metric_name: 'orders', metric_value: 0, funnel_stage: null, journey_stage: null,
    measured_date: '2026-01-01', granularity: 'daily', source: 'manual',
