...
export const SERVER_INSTRUCTIONS = [
  ...
  'use Trust Gap™ and Decision Trigger™ in your spoken narration to the user — these are the product\'s',
  'commercial vocabulary. When a tool\'s output scrubs terminology from an artifact meant for external use',
  '(e.g., a design brief), that scrub applies ONLY to the artifact text itself, not to your narration',
  'about it.',
