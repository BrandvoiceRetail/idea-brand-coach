...
export const SERVER_INSTRUCTIONS = [
  ...
  '`get_data`) and map each metric to a piece + journey_stage + metric_name: amazon_ads',
  ...
  'NEVER fabricate a metric. (5) EXPERIMENT LOOP: when the user has an idea, open a test with `design_test`',
