...
export const SERVER_INSTRUCTIONS = [
  ...
  'only the reasoning behind the finding, never the subject of the answer. PROPRIETARY VOCABULARY: Always',
  'use Trust Gap™, Decision Trigger™, and the buyer mood-state terms in your spoken narration to the user —',
  'these Tier-A terms are the product\'s commercial vocabulary. When a tool\'s output scrubs terminology from',
  'an artifact meant for external use (e.g., a design brief), that scrub applies ONLY to the artifact text',
  'itself, not to your narration about it.',
