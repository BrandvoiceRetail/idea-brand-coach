...
| **3 — Fix** | `V4Fix` + `DriftBanner` / `FunnelMap` / `WhatNeedsWork` / `AssetDetailTabs` | S-12..S-15 | ✅ Built + green. Five-stage map, impact list, per-asset tabs (prompt / brief / check), Signature drift. Lift ranking honest-degrades to coverage until S-20 analytics land. |
