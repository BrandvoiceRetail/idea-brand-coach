...
serve(async (req) => {
  ...
  try {
    ...
    console.log('System KB context length:', systemKBContext.length);
    console.log('User KB context length:', userKnowledgeContext.length);
...
Always encourage iterative refinement and ask clarifying questions when input lacks detail for optimal strategic guidance.`;
    ...
    console.log('Has system KB context:', !!systemKBContext);
