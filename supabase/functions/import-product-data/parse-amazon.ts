 ...
 * `_shared`, so the frontend module cannot be imported here. The frontend twin is
 * tested by `src/lib/__tests__/parseAmazonProduct.test.ts`; this copy must stay
 * behaviorally identical. Any change here must be mirrored there (and vice versa).
 */
